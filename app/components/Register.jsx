...
const Register = ({eventid,setShow}) => {
    ...
    <div className="flex w-[60%]  flex-col justify-end mr-30px border-[1px] px-[20px]
     bg-blue-950 rounded-md border-yellow-300 shadow-black shadow-md absolute z-20 top-[30%] left-[20%]">

      <div className=" flex  justify-between flex-col sm:flex-row ">
       <div className="flex sm:w-[40%] flex-col justify-center mb-[20px] w-full">
       <label className="flex w-full justify-end text-[12px] sm:text-[14px] md:text-[17px] botder-b-[1px] border-yellow-400 text-white" text-white>اللقب</label>
        <select className="flex text-[12px] sm:text-[14px] md:text-[17px] w-full text-right h-[40px]  bg-blue-950  text-white outline-none border-b-[1px] border-yellow-300"
        ...
        <div className="flex sm:w-[40%] flex-col justify-center mb-[20px] w-full">
        <label className="flex w-full justify-end text-[12px] sm:text-[14px] md:text-[17px]  botder-b-[1px] border-yellow-400 text-white">الاسم</label>
        <input type="text" 
        value={name}
        ...
        <div className="flex  justify-between flex-col sm:flex-row">
        <div className="flex sm:w-[40%] flex-col justify-center mb-[20px] w-full">
        <label className="flex w-full justify-end text-[12px] md:text-[17px] sm:text-[14px] botder-b-[1px] border-yellow-400 text-white">البريد الإلكتروني</label>
        <input type="text"
        value={email}
        ...
        <div className="flex sm:w-[40%] flex-col justify-center mb-[20px] w-full">
        <label className="flex w-full justify-end text-[12px] md:text-[17px] sm:text-[14px]  botder-b-[1px] border-yellow-400 text-white">الجوال</label>
        <input type="text" 
        value={whatsapp}
        onChange={(e)=>{setWhatsapp(e.target.value)}}
        className="flex w-full text-right h-[40px]  bg-transparent md:text-[17px] sm:text-[14px] text-white outline-none border-b-[1px] border-yellow-300"/>
        </div>
        </div>

        <div className="flex  justify-between flex-col sm:flex-row">
        <div className="flex sm:w-[40%] flex-col justify-center mb-[20px] w-full">
        <label className="flex w-full justify-end text-[12px] botder-b-[1px] md:text-[17px] sm:text-[14px] border-yellow-400 text-white">المنظمة</label>
        <input type="text"
        value={orgnization}
        ...
        <div className="flex sm:w-[40%]  flex-col justify-center mb-[20px] w-full">
        <label className="flex w-full justify-end text-[8px] botder-b-[1px] border-yellow-400 text-white md:text-[17px] sm:text-[14px] max-w-xs:sm:text-[8px] ">المنصب</label>
        <input type="text"
        value={position}
