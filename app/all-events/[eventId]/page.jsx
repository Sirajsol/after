...
<div className=' flex flex-col justify-start bg-blue-950  my-[20px] sm:my-[50px] pb-[20px] w-[80%] mx-auto text-white rounded-md shadow-md shadow-black '>
    ...
    <div className='flex text-[25px]  w-[96%] justify-center mt-[30px] mx-auto pb-[30px]
     border-[1px] rounded-md shadow-white shadow-md flex-col sm:flex-row'>
    ...
    <div className='flex flex-col w-[96%] mx-auto justify-start  mt-[20px] items-start text-white text-[15px] sm:text-[18px] overflow-hidden ml-[5px]'>
       <div className='flex mb-[30px]  w-[92%] mx-auto pb-[20px] overflow-scroll  text-right text-wrap'>{evt.description}</div> 
